...
- Lafont, [*Towards an algebraic theory of Boolean
  circuits*](https://www.sciencedirect.com/science/article/pii/S0022404902001497)
  — circuits presented by generators and relations: copy/discard and
  add/zero as a bimonoid. The source of the presentation `linear?`
  tests for by hand.
- Bonchi, Sobociński & Zanasi, [*Interacting Hopf
  algebras*](https://arxiv.org/abs/1403.7048) — the PROP of matrices
  over a semiring, generated by a comonoid, a monoid, the symmetry
  and the scalars. Why transposition is exactly the exchange of the
  two structures, which is what `transpose.braid` does atom by atom
  (`dup ↔ +`, `drop ↔ 0`).

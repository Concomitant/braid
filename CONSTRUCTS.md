...
| `resource R = Ty` | a wire the elaborator threads | nothing | nothing | the `data` machinery plus the routing pass (`elabScope`) | `resources`, `metered`, `payroll`, `lifting`, `prob`, `autodiff` |
